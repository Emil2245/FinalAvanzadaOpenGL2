...
import ec.edu.uce.pa.geometria.Prisma;
...
public class RenderPrisma implements GLSurfaceView.Renderer {
    ...
    public RenderPrisma(Context contexto) {
        this.context = contexto;
        prisma = new Prisma(0.5f,1,5,contexto,matrizProyeccion,matrizVista,matrizModelo);
